        ...
        <View style={styles.background}>
            ...
            <LinearGradient colors={['#5DCBEC', '#3790CE']}>
                <View style={{
                    ...
                    <TouchableOpacity style={{marginLeft: scale(115)}} onPress={() => navigation.navigate('NewMessage')}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('ChatScreen')} style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{color:'black', fontFamily:'Montserrat-Regular'}}>Adeel Ahmed (Infant Room)</Text>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('ChatScreen')} style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{color:'black', fontFamily:'Montserrat-Regular'}}>Ahmed Raza (Infant Room)</Text>
                        <Text style={{color:'#4D4D4D',fontFamily:'Montserrat-Regular', fontSize:scale(10)}}>{currentTime} {currentDate}</Text>
                    </View>
                </View>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => navigation.navigate('ChatScreen')} style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={{color:'black', fontFamily:'Montserrat-Regular'}}>Hussain Raza (Infant Room)</Text>
                        <Text style={{color:'#4D4D4D',fontFamily:'Montserrat-Regular', fontSize:scale(10)}}>{currentTime} {currentDate}</Text>
                    </View>
                </View>
            </TouchableOpacity>
