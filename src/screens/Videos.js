        ...
        <View style={styles.background}>
            <LinearGradient colors={['#5DCBEC', '#3790CE']}>
                <View style={{
                    ...
                    <TouchableOpacity style={{marginLeft: scale(109)}} onPress={() => navigation.navigate('Addvideo')}>
            ...
            <FlatList
                ...
                renderItem={({item}) =>(
                    ...
                    {/* <TouchableOpacity onPress={() => setModalVisible(true)}> */}
                        <View style={{backgroundColor: '#fff', alignSelf: 'center', zIndex: 1, padding: 10, top: 50, borderRadius: 50}}>
                            <FontAwesome5 name="play" color='#000' size={15} style={{marginLeft: scale(2)}} />
                        </View>   
                    {/* </TouchableOpacity>  */}
                        <TouchableOpacity onPress={() => setModalVisible(true)}>
